      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-4 py-8 md:grid-cols-2">
          <div className="text-xs leading-6 text-white/60">
            <div>상호: 주식회사 해강홀딩스/ Hae Gang Co, Ltd. | 대표: 이서우 | 사업자등록번호: 110-86-19547</div>
            <div>주소: 서울특별시 서초구 효령로31길 15 | Email. info@Bunnystock.io</div>
          </div>
          <div className="flex items-end justify-start md:justify-end">
            <p className="text-xs text-white/50">
              © {new Date().getFullYear()} Hae Gang. All rights reserved.
            </p>
          </div>
        </div>
      </div>
