...
const FAQS: FAQ[] = [
  {
    q: "Bunny Stock은 어떤 회사인가요?",
    a: (
      <p className="text-white/90">
        Bunny Stock은 금융위원회에 정식 신고된 유사투자자문업체로, 투자자가 합리적인 의사결정을 할 수 있도록
        시장 정보, 데이터 분석, 투자 교육을 제공하는 전문 기관입니다.
      </p>
    ),
    searchText:
      "Bunny Stock 어떤 회사 금융위원회 정식 신고 유사투자자문 시장 정보 데이터 분석 투자 교육",
  },
  {
  ...
  },
  {
    ...
    a: (
      <p className="text-white/90">
        네. Bunny Stock은 금융위원회에 신고된 합법적 유사투자자문업체로,
